...
Hầu hết các nhóm mà tôi làm việc cùng cố gắng quản lý rủi ro một cách rất thận trọng. Họ tối thiểu số lượng thay đổi mà họ thực hiện đối với code. Đôi khi chính sách của nhóm là: “Nếu nó không bị hỏng, đừng sửa nó.” Vào những thời điểm khác, đó không phải là điều mà ai cũng có thể nói rõ. Các lập trình viên rất thận trọng khi họ thực hiện các thay đổi. "Cái gì? Tạo một phương thức khác cho điều này? Không, tôi sẽ đặt các dòng code đó ngay tại đây, trong phương thức này, nơi tôi có thể nhìn thấy chúng và phần còn lại của code. Nó ít phải chỉnh sửa hơn và an toàn hơn.”

Thật hấp dẫn khi nghĩ rằng chúng ta có thể tối thiểu hóa sự cố của phần mềm bằng cách tránh chúng, nhưng thật không may, nó luôn bắt kịp chúng ta. Khi chúng ta tránh tạo các lớp và phương thức mới, những lớp và phương thức hiện có sẽ trở nên lớn hơn và khó hiểu hơn. Khi bạn thực hiện các thay đổi trong bất kỳ hệ thống lớn nào, bạn có thể mất một khoảng thời gian để làm quen với vùng bạn đang làm việc. Sự khác biệt giữa hệ thống tốt và hệ thống tồi là ở những hệ thống tốt, bạn cảm thấy khá bình tĩnh sau khi tìm hiểu xong và bạn tự tin vào sự thay đổi mình sắp thực hiện. Trong hệ thống có cấu trúc kém, việc chuyển từ tìm hiểu mọi thứ sang thực hiện các thay đổi giống như nhảy khỏi vách đá để tránh hổ. Bạn lưỡng lự và do dự. "Tôi đã sẵn sàng để thực hiện điều này chưa? Chà, tôi đoán là tôi phải làm vậy."

Tránh thay đổi có những hậu quả xấu khác. Khi mọi người không thực hiện các thay đổi thường xuyên, họ sẽ cảm thấy khó khăn với nó. Chia nhỏ một lớp lớn thành nhiều phần có thể là công việc khá phức tạp trừ khi bạn thực hiện việc đó vài lần một tuần. Khi đó, nó sẽ trở thành thói quen. Bạn trở nên giỏi hơn trong việc tìm ra cái gì có thể hỏng và cái gì không, và điều đó dễ thực hiện hơn nhiều.

Hậu quả cuối cùng của việc tránh thay đổi là sự sợ hãi. Thật không may, nhiều nhóm sống với nỗi sợ thay đổi đáng kinh ngạc và nó trở nên tồi tệ hơn mỗi ngày. Thường thì họ không nhận thức được mức độ sợ hãi của mình cho đến khi họ học được những kỹ thuật tốt hơn và nỗi sợ hãi bắt đầu biến mất.

Chúng ta đã nói về việc né tránh thay đổi là một điều tồi tệ như thế nào, nhưng đâu là giải pháp thay thế cho chúng ta? Một giải pháp thay thế là chỉ cần cố gắng hơn nữa. Có lẽ chúng ta có thể thuê thêm người để có đủ thời gian cho mọi người ngồi phân tích, xem xét kỹ lưỡng tất cả code và thực hiện các thay đổi “đúng cách”. Chắc chắn có nhiều thời gian và sự xem xét kỹ lưỡng hơn sẽ giúp cho sự thay đổi trở nên an toàn hơn. Hoặc không? Sau tất cả sự xem xét kỹ lưỡng đó, liệu có ai biết rằng họ đã hiểu đúng?
